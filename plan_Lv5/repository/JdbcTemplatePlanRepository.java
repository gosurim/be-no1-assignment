...
import com.example.plan.exception.NotFoundException;
import com.example.plan.exception.PwMismatchException;
...
public class JdbcTemplatePlanRepository implements PlanRepository{
    ...
    public Plan findMemoByIdOrElseThrow(Long id) {
        ...
        Plan plan = result.stream().findAny().orElseThrow(
