...
public class Plan {
    ...
    public Plan(String name, String pw, String todo, String date, String modi, Long userId){
        this.name = name;
        this.pw = pw;
        this.todo = todo;
        this.date = date;
    ...
    public Plan(long id, String name, String todo, String date, String modi, Long userId) {
        this.id = id;
        this.name = name;
        this.todo = todo;
        this.date = date;
